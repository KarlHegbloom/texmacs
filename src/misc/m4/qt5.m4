...
dnl qtHaveModule(network):           QT += network
...
dnl qtHaveModule(widgets):           QT += widgets
dnl qtHaveModule(x11extras):         QT += x11extras
dnl qtHaveModule(xml):               QT += xml
